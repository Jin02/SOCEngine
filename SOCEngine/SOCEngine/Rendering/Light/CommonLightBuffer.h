	...
	namespace Light
	{
		namespace Buffer
		{
			...
			public:
				...
				GET_ALL_ACCESSOR(ColorSRBuffer,				 auto&,	_colorBuffer.GetShaderResourceBuffer());
				GET_ALL_ACCESSOR(OptionalParamIndexSRBuffer, auto&,	_optionalParamIndexBuffer.GetShaderResourceBuffer());
