...
namespace Rendering
{
	namespace PostProcessing
	{
		...
		private:
			...
			std::vector<Shader::BaseShader::InputTexture>	_inputPSTextures;
		...
		public:
			GET_SET_ACCESSOR(InputPSTextures, const std::vector<Shader::BaseShader::InputTexture>&, _inputPSTextures);
		};
	}
}